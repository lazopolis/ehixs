...
c        write(*,'(a36,a36)') '#                                   '
c     &                      ,'                                   #'
c        write(*,'(a36,a36)') '#                      You are using'
c     &                      ,' OneLOop 1.1                       #'
c        write(*,'(a36,a36)') '#                                   '
c     &                      ,'                                   #'
c        write(*,'(a36,a36)') '# for the evaluation of 1-loop scala'
c     &                      ,'r 1-, 2-, 3- and 4-point functions #'
c        write(*,'(a36,a36)') '#                                   '
c     &                      ,'                                   #'
c        write(*,'(a36,a36)') '# author: Andreas van Hameren <hamer'
c     &                      ,'enREMOVETHIS@ifj.edu.pl>           #'
c        write(*,'(a36,a36)') '#   date: 09-09-2010                '
c     &                      ,'                                   #'
c        write(*,'(a36,a36)') '#                                   '
c     &                      ,'                                   #'
c        write(*,'(a36,a36)') '# Please cite                       '
c     &                      ,'                                   #'
c        write(*,'(a36,a36)') '#    A. van Hameren, arXiv:1007.4716'
c     &                      ,' [hep-ph]                          #'
c        write(*,'(a36,a36)') '#    A. van Hameren, C.G. Papadopoul'
c     &                      ,'os and R. Pittau,                  #'
c        write(*,'(a36,a36)') '#    JHEP 0909:106,2009, arXiv:0903.'
c     &                      ,'4665 [hep-ph]                      #'
c        write(*,'(a36,a36)') '# in publications with results obtai'
c     &                      ,'ned with the help of this program. #'
c        write(*,'(a36,a36)') '#                                   '
c     &                      ,'                                   #'
c        write(*,'(a36,a36)') '####################################'
c     &                      ,'####################################'
