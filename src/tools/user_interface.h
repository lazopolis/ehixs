...
/// \todo Does this not get defined in a header?
//: declaring the getopt specialized class option (not small initial 'o')
class option;

/// \todo Write an enum OptionType to get rid of the string/int mess
...
struct Option {
    ...
    Option(const string& name_, char short_name_, const string& desc_, const string& type_)
    : name(name_),short_name(short_name_),desc(desc_),type(type_)
    {};
...
public:
    /** Constructor */
    StringOption(const string& name_, char short_name_, const string& desc_, const string & type_,  string * p_, const string& def)
...
public:
    /** Constructor */
    DoublePrecisionOption(const string& name_, char short_name_, const string& desc_, const string & type_,  double * p_,const double & def)
...
public:
    /** Constructor */
    IntOption(const string& name_, char short_name_, const string& desc_, const string & type_,  int * p_,int def)
    : Option(name_, short_name_, desc_, type_), p(p_){*p=def;}
...
public:
    /** Constructor */
    BoolOption(const string& name_, char short_name_, const string& desc_, const string & type_,  bool * p_,bool def)
    : Option(name_, short_name_, desc_, type_), p(p_){*p=def;}
