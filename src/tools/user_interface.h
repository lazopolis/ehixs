...
public://data
    double Etot,m_higgs,epsrel,epsabs,muf_over_mhiggs,mur_over_mhiggs,number_of_flavours,epsrel_therm,epsabs_therm;
    ...
    pdf_error, dummy_process,ew_soft,ew_h_plus_j,only_ew_h_j,bin_by_bin_integration;
