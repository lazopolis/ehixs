     ...
     &(s, XB1, XB2, z, lh, wd, nf, x1, x2, x3, x4) 
      ...
      t22 = rrgg2qqbarh41J2(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, 0.0D0,
     # t3, -t5, 0.0D0)
      t24 = t21 ** 2
      t25 = rrgg2qqbarh41J1(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, 0.0D0,
     # t3, -t5, 0.0D0)
      t28 = rrgg2qqbarh41J3(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, 0.0D0,
     # t3, -t5, 0.0D0)
      t33 = pi * lh
      t34 = t6 * t8
      t40 = lh ** 2
      ...
      t58 = t54 ** 2
      t59 = t58 * pi
      t66 = rrgg2qqbarh41J4(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, 0.0D0,
     # t3, -t5, 0.0D0)
      t95 = x3 * t11
      t96 = t95 * t13
     ...
     #D3 + t7 * t8 * t66 / 0.8D1 + (pi * (0.60D2 * lh * t42 - 0.240D3 * 
     #zeta3 - 0.120D3 * t40 * lh) - t55 * t44 - 0.90D2 * t59 * lh - 0.15
     #D2 * t58 * t54 * pi) * t6 * t8 * t25 / 0.720D3 + (-0.180D3 * t33 -
     ...
     #D3 * t33 * t34 * (t22 - t116 * t25) + t47) * t108 / 0.720D3
      ...
      t164 = rrgg2qqbarh41J2(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t142
     #, t139, t145, -t151)
      t167 = t160 ** 2
      t169 = rrgg2qqbarh41J1(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t142
     #, t139, t145, -t151)
      t170 = t163 * t169
      t173 = t146 * t163
      t174 = rrgg2qqbarh41J3(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t142
     #, t139, t145, -t151)
      t180 = t173 * t164
      t186 = t45 * t6
      t188 = t8 * t146 * t170
     ...
     #D3
      ...
      t232 = t225 * t231
      t233 = rrgg2qqbarh41J2(s, XB1, XB2, z, lh, wd, nf, s, t220, 0.0D0,
     # -t223, -t224, -t229)
      t234 = t232 * t233
      t235 = t16 * t221
      t236 = t225 ** 2
      t241 = log(-0.4D1 * t193 * t235 * x4 * t236)
      t243 = rrgg2qqbarh41J1(s, XB1, XB2, z, lh, wd, nf, s, t220, 0.0D0,
     # -t223, -t224, -t229)
      t244 = t231 * t243
      t251 = t8 * t225 * t244
      ...
      t262 = t261 * t225
      t265 = t261 ** 2
      t269 = rrgg2qqbarh41J3(s, XB1, XB2, z, lh, wd, nf, s, t220, 0.0D0,
     # -t223, -t224, -t229)
     ...
     #* t298 * t301)
      ...
      t310 = rrgg2qqbarh41J2(s, XB1, XB2, z, lh, wd, nf, s, t289, -t291,
     # -t290, t292, t306)
      t312 = t293 ** 2
      t317 = log(0.4D1 * t193 * t154 * t235 * t312)
      t319 = rrgg2qqbarh41J1(s, XB1, XB2, z, lh, wd, nf, s, t289, -t291,
     # -t290, t292, t306)
      t320 = t308 * t319
     ...
     #) - 0.180D3 * t203 * t8 * t293 * t320
      ...
      rrgg2qqbarht4s1e1 = t134 * t133 + t211 * t210 + t213 * t133 + t215
     ...
     &(s, XB1, XB2, z, lh, wd, nf, x1, x2, x3, x4) 
      ...
      t7 = pi * t6
      t8 = 0.1D1 / s
      t9 = rrgg2qqbarh41J2(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, 0.0D0, 
     #t3, -t5, 0.0D0)
      t10 = x2 * pi
      t11 = sin(t10)
      t12 = t11 ** 2
      ...
      t23 = rrgg2qqbarh41J1(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, 0.0D0,
     # t3, -t5, 0.0D0)
      t29 = pi * lh
      t30 = t6 * t8
      ...
      t71 = pi ** 2
      t77 = t61 ** 2
      t85 = rrgg2qqbarh41J3(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, 0.0D0,
     # t3, -t5, 0.0D0)
     ...
     #* t6 * t8 * t9 / 0.720D3 + (pi * (0.180D3 * t69 - 0.30D2 * t71) + 
     ...
     #+ t7 * t8 * t85 / 0.8D1
      ...
      t111 = rrgg2qqbarh41J2(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t98,
     # t95, t101, -t107)
      t115 = x4 * t99
      t116 = t102 ** 2
      t121 = log(-0.4D1 * t16 * t12 * t14 * t115 * t116 * t17)
      t123 = rrgg2qqbarh41J1(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t98,
     # t95, t101, -t107)
      t124 = t109 * t123
      t130 = t29 * t6
      t131 = t8 * t102
     ...
     #124 * t139 / 0.8D1
      ...
      t167 = rrgg2qqbarh41J1(s, XB1, XB2, z, lh, wd, nf, s, t153, 0.0D0,
     # -t156, -t157, -t162)
      t168 = t166 * t167
      t173 = rrgg2qqbarh41J2(s, XB1, XB2, z, lh, wd, nf, s, t153, 0.0D0,
     # -t156, -t157, -t162)
      t176 = t158 ** 2
     ...
     #* t208 * t211)
      ...
      t221 = rrgg2qqbarh41J1(s, XB1, XB2, z, lh, wd, nf, s, t199, -t201,
     # -t200, t202, t216)
     ...
     &(s, XB1, XB2, z, lh, wd, nf, x1, x2, x3, x4) 
      ...
      t7 = pi * t6
      t8 = 0.1D1 / s
      t9 = rrgg2qqbarh41J1(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, 0.0D0, 
     #t3, -t5, 0.0D0)
      t10 = t8 * t9
      t11 = 0.1D1 / x3
      t15 = rrgg2qqbarh41J2(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, 0.0D0,
     # t3, -t5, 0.0D0)
      t22 = sin(x2 * pi)
      t23 = t22 ** 2
      t24 = z ** 2
     ...
     #9 / 0.8D1
      ...
      t61 = s * t56 * t6 * t59 * x4
      t62 = t7 * t8
      t66 = rrgg2qqbarh41J1(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t52, 
     #t49, t55, -t61)
      ...
      t92 = t84 ** 2
      t96 = s * t92 * t6 * t59 * x3
      t100 = rrgg2qqbarh41J1(s, XB1, XB2, z, lh, wd, nf, s, t87, 0.0D0, 
     #-t90, -t91, -t96)
      t102 = t92 / (-0.2D1 + t84) * t100 * t11
      t104 = t62 * t102 / 0.8D1
      t105 = FJET(XB1, XB2, s, t87, -t90, 0.0D0, -t91, -t96, t104)
      t110 = FJET(XB1, XB2, s, -t90, t87, -t91, 0.0D0, -t96, t104)
      rrgg2qqbarht4s1em1 = t44 * t43 + t71 * pi * t73 * t68 / 0.8D1 + t7
     #7 * t43 + t79 * pi * t73 * t68 / 0.8D1 + t105 * pi * t73 * t102 / 
     ...
     #t3, -t5, 0.0D0)
      ...
      rrgg2qqbarht4s1em2 = t13 * pi * t16 / 0.8D1 + t18 * pi * t16 / 0.8
     #D1
     ...
     &(s, XB1, XB2, z, lh, wd, nf, S12, S13, S14, S23, S24, S34) 
      ...
      t4 = S23 ** 2
      t5 = S24 ** 2
      rrgg2qqbarh41J1 = (-nf * S12 / 0.3D1 + (-S24 - S23) * nf / 0.3D1 +
     # (-t4 - t5) * nf / S12 / 0.3D1) / pi * wd / z
     ...
     &(s, XB1, XB2, z, lh, wd, nf, S12, S13, S14, S23, S24, S34) 
      ...
      t1 = S24 ** 2
      t2 = S23 ** 2
      rrgg2qqbarh41J2 = (-t1 - t2 + 0.2D1 * S23 * S24) * nf / S12 / pi *
     # wd / z / 0.3D1
     ...
     &(s, XB1, XB2, z, lh, wd, nf, S12, S13, S14, S23, S24, S34) 
      ...
      t4 = S23 ** 2
      t7 = S24 ** 2
      rrgg2qqbarh41J3 = (nf * S12 / 0.3D1 + (S23 + S24) * nf / 0.3D1 + (
     #-t4 + 0.4D1 * S23 * S24 - t7) * nf / S12 / 0.3D1) / pi * wd / z
     ...
     &(s, XB1, XB2, z, lh, wd, nf, S12, S13, S14, S23, S24, S34) 
      ...
      t7 = S23 ** 2
      t10 = S24 ** 2
      rrgg2qqbarh41J4 = (0.2D1 / 0.3D1 * nf * S12 + (0.2D1 * S23 + 0.2D1
     # * S24) * nf / 0.3D1 + (-t7 + 0.6D1 * S23 * S24 - t10) * nf / S12 
     #/ 0.3D1) / pi * wd / z
     ...
     &(s, XB1, XB2, z, lh, wd, nf, S12, S13, S14, S23, S24, S34) 
      ...
      t6 = S23 ** 2
      t9 = S24 ** 2
      rrgg2qqbarh41J5 = (nf * S12 + (0.3D1 * S23 + 0.3D1 * S24) * nf / 0
     #.3D1 + (-t6 + 0.8D1 * S23 * S24 - t9) * nf / S12 / 0.3D1) / pi * w
     #d / z
     ...
     &(s, XB1, XB2, z, lh, wd, nf, S12, S13, S14, S23, S24, S34) 
      ...
      t9 = S23 ** 2
      t10 = S24 ** 2
      rrgg2qqbarh41J6 = (0.10D2 / 0.3D1 * nf * S12 + 0.5D1 / 0.3D1 * (0.
     #2D1 * S23 + 0.2D1 * S24) * nf + 0.5D1 / 0.3D1 * (0.2D1 * S23 * S24
     # + t9 + t10) * nf / S12) / pi * wd / z
