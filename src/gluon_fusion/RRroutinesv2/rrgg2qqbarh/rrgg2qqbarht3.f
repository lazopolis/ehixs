     ...
     &(s, XB1, XB2, z, lh, wd, nf, x1, x2, x3, x4) 
      ...
      t18 = 0.1D1 / (-0.2D1 + t1)
      t19 = t9 * t18
      t20 = rrgg2qqbarh31J3(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t8, t
     #5, 0.0D0, -t14)
      t21 = t19 * t20
      t22 = x2 * pi
      t23 = sin(t22)
      ...
      t37 = t36 * t9
      t38 = rrgg2qqbarh31J2(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t8, t
     #5, 0.0D0, -t14)
      t39 = t18 * t38
      t41 = t36 ** 2
      t43 = rrgg2qqbarh31J1(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t8, t
     #5, 0.0D0, -t14)
      t44 = t18 * t43
      t51 = pi * lh
      t52 = t11 * t16
      ...
      t81 = t77 ** 2
      t82 = t81 * pi
      t90 = rrgg2qqbarh31J4(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t8, t
     #5, 0.0D0, -t14)
      t120 = x3 * t24
      t121 = t120 * t26
     ...
     # + t144 * t44) - t68) * t137 / 0.720D3
      ...
      t182 = t174 * t181
      t183 = rrgg2qqbarh31J3(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, t171,
     # t168, -t173, t179)
      t185 = t174 ** 2
      t187 = t31 * t169 * t185
      t190 = log(-0.4D1 * t29 * t187)
      t191 = t190 * t174
      t192 = rrgg2qqbarh31J2(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, t171,
     # t168, -t173, t179)
      t195 = t190 ** 2
      t197 = rrgg2qqbarh31J1(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, t171,
     # t168, -t173, t179)
      t198 = t181 * t197
      t205 = t182 * t192
      t212 = t16 * t174 * t198
     ...
     #0D3
      ...
      t255 = t248 * t254
      t256 = rrgg2qqbarh31J2(s, XB1, XB2, z, lh, wd, nf, s, t243, -t247,
     # -t246, 0.0D0, t252)
      t257 = t255 * t256
      t258 = t30 * t244
      t259 = t248 ** 2
      t264 = log(-0.4D1 * t217 * t258 * x4 * t259)
      t266 = rrgg2qqbarh31J1(s, XB1, XB2, z, lh, wd, nf, s, t243, -t247,
     # -t246, 0.0D0, t252)
      t267 = t254 * t266
      t274 = t16 * t248 * t267
      t280 = rrgg2qqbarh31J3(s, XB1, XB2, z, lh, wd, nf, s, t243, -t247,
     # -t246, 0.0D0, t252)
     ...
     # + 0.2D1 * t321 * t325)
      ...
      t334 = rrgg2qqbarh31J2(s, XB1, XB2, z, lh, wd, nf, s, t312, t314, 
     #-t313, -t315, t330)
      t336 = t316 ** 2
      t341 = log(0.4D1 * t217 * t258 * t323 * t336)
      t343 = rrgg2qqbarh31J1(s, XB1, XB2, z, lh, wd, nf, s, t312, t314, 
     #-t313, -t315, t330)
      t344 = t332 * t343
     ...
     #37 * t70 / 0.720D3)
      rrgg2qqbarht3s1e1 = t163 * t162 + t234 * t233 + t236 * t162 + t238
     ...
     &(s, XB1, XB2, z, lh, wd, nf, x1, x2, x3, x4) 
      ...
      t18 = 0.1D1 / (-0.2D1 + t1)
      t19 = t9 * t18
      t20 = rrgg2qqbarh31J2(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t8, t
     #5, 0.0D0, -t14)
      t21 = t19 * t20
      t22 = x2 * pi
      t23 = sin(t22)
      ...
      t32 = t9 ** 2
      t36 = log(0.4D1 * t29 * t31 * t32)
      t38 = rrgg2qqbarh31J1(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t8, t
     #5, 0.0D0, -t14)
      t39 = t18 * t38
      t45 = pi * lh
      t46 = t45 * t11
      ...
      t78 = rrgg2qqbarh31J3(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t8, t
     #5, 0.0D0, -t14)
     ...
     #lh + 0.45D2 * t101 * pi) * t11 * t16 * t19 * t38 / 0.720D3
      ...
      t131 = rrgg2qqbarh31J2(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, t119,
     # t116, -t121, t127)
      t133 = t122 ** 2
      t138 = log(-0.4D1 * t29 * t31 * t117 * t133)
      t140 = rrgg2qqbarh31J1(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, t119,
     # t116, -t121, t127)
      t141 = t129 * t140
      t147 = t16 * t122
     ...
     # t141 * t57 / 0.8D1
      ...
      t182 = rrgg2qqbarh31J1(s, XB1, XB2, z, lh, wd, nf, s, t168, -t172,
     # -t171, 0.0D0, t177)
      t183 = t181 * t182
      t188 = rrgg2qqbarh31J2(s, XB1, XB2, z, lh, wd, nf, s, t168, -t172,
     # -t171, 0.0D0, t177)
      t190 = t173 ** 2
     ...
     # + 0.2D1 * t222 * t226)
      ...
      t236 = rrgg2qqbarh31J1(s, XB1, XB2, z, lh, wd, nf, s, t213, t215, 
     #-t214, -t216, t231)
     ...
     # * t158 + t209 * t208 - t241 * pi * t243 * t248 / 0.8D1 + t251 * t
     #208 - t253 * pi * t243 * t248 / 0.8D1
     ...
     &(s, XB1, XB2, z, lh, wd, nf, x1, x2, x3, x4) 
      ...
      t17 = pi * t11 * t16
      t20 = t9 / (-0.2D1 + t1)
      t21 = rrgg2qqbarh31J1(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t8, t
     #5, 0.0D0, -t14)
      t22 = 0.1D1 / x3
      t27 = rrgg2qqbarh31J2(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, -t8, t
     #5, 0.0D0, -t14)
      t34 = sin(x2 * pi)
      t35 = t34 ** 2
      t36 = z ** 2
     ...
     #0.720D3 - t17 * t20 * t21 * t55 / 0.8D1
      ...
      t81 = rrgg2qqbarh31J1(s, XB1, XB2, z, lh, wd, nf, s, 0.0D0, t69, t
     #66, -t71, t77)
      ...
      t115 = rrgg2qqbarh31J1(s, XB1, XB2, z, lh, wd, nf, s, t102, -t106,
     # -t105, 0.0D0, t111)
      ...
      rrgg2qqbarht3s1em1 = t61 * t60 + t86 * pi * t88 * t83 / 0.8D1 + t9
     #2 * t60 + t94 * pi * t88 * t83 / 0.8D1 + t120 * pi * t88 * t117 / 
     ...
     #5, 0.0D0, -t14)
      ...
      rrgg2qqbarht3s1em2 = -t25 * pi * t11 * t30 / 0.8D1 - t32 * pi * t1
     #1 * t30 / 0.8D1
     ...
     &(s, XB1, XB2, z, lh, wd, nf, S12, S13, S14, S23, S24, S34) 
      ...
      doubleprecision zeta7
      parameter(zeta7=1.008349277381923d0)
      rrgg2qqbarh31J1 = (0.4D1 / 0.3D1 * nf * S34 - 0.4D1 / 0.3D1 * S14 
     #* S23 * nf / S12) / pi * wd / z
     ...
     &(s, XB1, XB2, z, lh, wd, nf, S12, S13, S14, S23, S24, S34) 
      ...
      t7 = S14 ** 2
      t9 = S23 ** 2
      rrgg2qqbarh31J2 = (0.4D1 / 0.3D1 * nf * S12 + 0.8D1 / 0.3D1 * nf *
     # S34 + (-0.16D2 * S14 * S23 - 0.4D1 * t7 - 0.4D1 * t9) * nf / S12 
     #/ 0.6D1) / pi * wd / z
     ...
     &(s, XB1, XB2, z, lh, wd, nf, S12, S13, S14, S23, S24, S34) 
      ...
      t24 = S14 ** 2
      t26 = S23 ** 2
      rrgg2qqbarh31J3 = (0.8D1 * t1 * t2 * s * z + 0.4D1 * nf * S12 + 0.
     #2D1 * t1 + t10 * nf / 0.3D1 + (-0.7D1 * nf * t14 - 0.13D2 / 0.3D1 
     #* t10 * nf * S34 + (-0.28D2 * S14 * S23 - 0.7D1 * t24 - 0.7D1 * t2
     #6) * nf / 0.6D1) * t2) / pi * wd / z
     ...
     &(s, XB1, XB2, z, lh, wd, nf, S12, S13, S14, S23, S24, S34) 
      ...
      t24 = S14 ** 2
      t26 = S23 ** 2
      rrgg2qqbarh31J4 = (0.16D2 * t1 * t2 * s * z + 0.20D2 / 0.3D1 * nf 
     #* S12 + 0.4D1 / 0.3D1 * t1 + 0.2D1 / 0.3D1 * t10 * nf + (-0.14D2 *
     # nf * t14 - 0.26D2 / 0.3D1 * t10 * nf * S34 + (-0.40D2 * S14 * S23
     # - 0.10D2 * t24 - 0.10D2 * t26) * nf / 0.6D1) * t2) / pi * wd / z
     ...
     &(s, XB1, XB2, z, lh, wd, nf, S12, S13, S14, S23, S24, S34) 
      ...
      t24 = S14 ** 2
      t26 = S23 ** 2
      rrgg2qqbarh31J5 = (0.24D2 * t1 * t2 * s * z + 0.28D2 / 0.3D1 * nf 
     #* S12 + 0.2D1 / 0.3D1 * t1 + t10 * nf + (-0.21D2 * nf * t14 - 0.13
     #D2 * t10 * nf * S34 + (-0.52D2 * S14 * S23 - 0.13D2 * t24 - 0.13D2
     ...
     &(s, XB1, XB2, z, lh, wd, nf, S12, S13, S14, S23, S24, S34) 
      ...
      t22 = S14 ** 2
      t23 = S23 ** 2
      rrgg2qqbarh31J6 = (0.32D2 * t1 * t2 * s * z + 0.12D2 * nf * S12 - 
     #0.8D1 * t1 + 0.4D1 / 0.3D1 * t10 * nf + (-0.28D2 * nf * t14 - 0.52
     #D2 / 0.3D1 * t10 * nf * S34 + (-0.16D2 * t22 - 0.16D2 * t23 - 0.16
     #D2 * S14 * S23) * nf / 0.6D1) * t2) / pi * wd / z
     ...
     &(s, XB1, XB2, z, lh, wd, nf, S12, S13, S14, S23, S24, S34) 
      ...
      t22 = S23 ** 2
      t23 = S14 ** 2
      rrgg2qqbarh31J7 = (0.40D2 * t1 * t2 * s * z + 0.20D2 / 0.3D1 * nf 
     #* S12 - 0.10D2 * t1 + 0.5D1 / 0.3D1 * t10 * nf + (-0.35D2 * nf * t
     #14 - 0.65D2 / 0.3D1 * t10 * nf * S34 + 0.5D1 / 0.6D1 * (t22 + t23 
     #- 0.4D1 * S14 * S23) * nf) * t2) / pi * wd / z
