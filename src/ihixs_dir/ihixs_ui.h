...
// UI for ihixs: the value of all options is now held by the option itself
class IhixsUI
{
public:
    /** Cosntructor **/
...
public://data
    double Etot,m_higgs,epsrel,epsabs,epsrel_therm,epsabs_therm,mur,muf;
    
    string pdf_provider,input_filename,output_filename,qcd_perturbative_order,pdf_set;
    
    int verbose,maxeval,mineval,nstart,nincrease,
        perturbative_order_for_pdfs;
    
    bool info,help,pdf_error;
