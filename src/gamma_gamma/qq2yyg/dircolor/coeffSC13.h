...
template<>
double qq2yygSC<13,-1>(const double& s12, const double& s13, const double& s14, const double& s23, const double& s24)
{
...
template<>
Expansion<Parameter::epsilon, double> qq2yygSC<13>(const double& s12, const double& s13, const double& s14, const double& s23, const double& s24)
{
    return Expansion<Parameter::epsilon, double>(-1,{
        qq2yygSC<13,-1>(s12,s13,s14,s23,s24)
    });
}
