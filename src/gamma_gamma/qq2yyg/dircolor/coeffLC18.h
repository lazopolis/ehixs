...
template<>
double qq2yygLC<18,0>(const double& s12, const double& s13, const double& s14, const double& s23, const double& s24)
{
...
template<>
double qq2yygLC<18,1>(const double& s12, const double& s13, const double& s14, const double& s23, const double& s24)
{
...
template<>
double qq2yygLC<18,2>(const double& s12, const double& s13, const double& s14, const double& s23, const double& s24)
{
...
template<>
Expansion<Parameter::epsilon, double> qq2yygLC<18>(const double& s12, const double& s13, const double& s14, const double& s23, const double& s24)
{
    return Expansion<Parameter::epsilon, double>(0,{
        qq2yygLC<18,0>(s12,s13,s14,s23,s24),
        qq2yygLC<18,1>(s12,s13,s14,s23,s24),
        qq2yygLC<18,2>(s12,s13,s14,s23,s24)
    });
}
