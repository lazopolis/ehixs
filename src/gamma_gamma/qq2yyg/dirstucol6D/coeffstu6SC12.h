...
template<>
double qq2yygstu6SC<12,-1>(const my_float& zb, const my_float& t12, const my_float& t34, const my_float& u)
{
...
template<>
Expansion<Parameter::epsilon, double> qq2yygstu6SC<12>(const my_float& zb, const my_float& t12, const my_float& t34, const my_float& u)
{
    return Expansion<Parameter::epsilon, double>(-1,{
        qq2yygstu6SC<12,-1>(zb,t12,t34,u)
    });
}
