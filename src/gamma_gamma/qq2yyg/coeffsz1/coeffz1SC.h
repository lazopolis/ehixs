...
#ifndef COEFF_Z1_SC_H
#define COEFF_Z1_SC_H
...
Expansion<Parameter::epsilon, double> qq2yygz1SC(
						   const my_float& zb,
						   const my_float& t12,
						   const my_float& t34,
						   const my_float& u
...
template<int eps>
double qq2yygz1SCbub1325(const my_float& zb, const my_float& t12, const my_float& t34);
...
/**
 * \fn    qq2yygz1SCbub1324
 * \brief First term of the Taylor series of c13*bub(s13)+c24*bub(s24) around s13=s24,
 *        power by power in epsilon, subleading color
 */

template<int eps>
double qq2yygz1SCbub1324(const my_float& zb, const my_float& t12, const my_float& u);
