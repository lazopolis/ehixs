...
template<>
double qq2yygz1SC<11,-1>(const my_float& zb, const my_float& t12, const my_float& t34, const my_float& u)
{
...
template<>
Expansion<Parameter::epsilon, double> qq2yygz1SC<11>(const my_float& zb, const my_float& t12, const my_float& t34, const my_float& u)
{
    return Expansion<Parameter::epsilon, double>(-1,{
        qq2yygz1SC<11,-1>(zb,t12,t34,u)
    });
}
