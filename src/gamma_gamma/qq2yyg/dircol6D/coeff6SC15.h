...
// Master n. 15: box(s12,s24,s12+s14+s24)

// Coefficient order epsilon^-1 of master 15
template<>
double qq2yyg6SC<15,-1>(const double& s12, const double& s13, const double& s14, const double& s23, const double& s24)
{
...
template<>
Expansion<Parameter::epsilon, double> qq2yyg6SC<15>(const double& s12, const double& s13, const double& s14, const double& s23, const double& s24)
{
    return Expansion<Parameter::epsilon, double>(-1,{
        qq2yyg6SC<15,-1>(s12,s13,s14,s23,s24)
    });
}
