...
double qq2yyg(const double& s12, const double& s13, const double& s14, const double& s23, const double& s24)
{
    ...
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<11>(s12,s13,s14,s23,s24),box6(s12,s13,s12+s13+s23,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<12>(s12,s13,s14,s23,s24),box6(s12,s14,s12+s14+s24,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<13>(s12,s13,s14,s23,s24),box6(s12,-s12-s13-s14,-s12-s13-s14-s23-s24,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<14>(s12,s13,s14,s23,s24),box6(s12,s23,s12+s13+s23,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<15>(s12,s13,s14,s23,s24),box6(s12,s24,s12+s14+s24,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<16>(s12,s13,s14,s23,s24),box6(s12,-s12-s23-s24,-s12-s13-s14-s23-s24,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<17>(s12,s13,s14,s23,s24),box6(s13,-s12-s13-s14-s23-s24,-s12-s23-s24,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<18>(s12,s13,s14,s23,s24),box6(s13,s12+s14+s24,s24,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<19>(s12,s13,s14,s23,s24),box6(s14,-s12-s13-s14-s23-s24,-s12-s23-s24,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<20>(s12,s13,s14,s23,s24),box6(s14,s12+s13+s23,s23,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<21>(s12,s13,s14,s23,s24),box6(-s12-s13-s14,s12+s14+s24,s24,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<22>(s12,s13,s14,s23,s24),box6(-s12-s13-s14,s12+s13+s23,s23,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<23>(s12,s13,s14,s23,s24),box6(s23,-s12-s13-s14-s23-s24,-s12-s13-s14,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<24>(s12,s13,s14,s23,s24),box6(s23,s12+s14+s24,s14,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<25>(s12,s13,s14,s23,s24),box6(s24,-s12-s13-s14-s23-s24,-s12-s13-s14,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<26>(s12,s13,s14,s23,s24),box6(s24,s12+s13+s23,s13,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<27>(s12,s13,s14,s23,s24),box6(-s12-s23-s24,s12+s14+s24,s14,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<28>(s12,s13,s14,s23,s24),box6(-s12-s23-s24,s12+s13+s23,s13,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<29>(s12,s13,s14,s23,s24),box6(-s12-s13-s14-s23-s24,s12+s14+s24,s12,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<30>(s12,s13,s14,s23,s24),box6(-s12-s13-s14-s23-s24,s12+s13+s23,s12,3),0);
    foo += CAm2CF*productCoeff(qq2yygCAm2CF<31>(s12,s13,s14,s23,s24),box6(s12+s14+s24,s12+s13+s23,s12,3),0);
    return foo;
}
...
double qq2yygAFbox(const double& s12, const double& s13, const double& s14, const double& s23, const double& s24)
{
    const double CAm2CF = QCD::CA-2.*QCD::CF;
    double fooAFbox(0.);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<11>(s12,s13,s14,s23,s24),box6(s12,s13,s12+s13+s23,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<12>(s12,s13,s14,s23,s24),box6(s12,s14,s12+s14+s24,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<13>(s12,s13,s14,s23,s24),box6(s12,-s12-s13-s14,-s12-s13-s14-s23-s24,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<14>(s12,s13,s14,s23,s24),box6(s12,s23,s12+s13+s23,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<15>(s12,s13,s14,s23,s24),box6(s12,s24,s12+s14+s24,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<16>(s12,s13,s14,s23,s24),box6(s12,-s12-s23-s24,-s12-s13-s14-s23-s24,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<17>(s12,s13,s14,s23,s24),box6(s13,-s12-s13-s14-s23-s24,-s12-s23-s24,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<18>(s12,s13,s14,s23,s24),box6(s13,s12+s14+s24,s24,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<19>(s12,s13,s14,s23,s24),box6(s14,-s12-s13-s14-s23-s24,-s12-s23-s24,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<20>(s12,s13,s14,s23,s24),box6(s14,s12+s13+s23,s23,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<21>(s12,s13,s14,s23,s24),box6(-s12-s13-s14,s12+s14+s24,s24,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<22>(s12,s13,s14,s23,s24),box6(-s12-s13-s14,s12+s13+s23,s23,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<23>(s12,s13,s14,s23,s24),box6(s23,-s12-s13-s14-s23-s24,-s12-s13-s14,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<24>(s12,s13,s14,s23,s24),box6(s23,s12+s14+s24,s14,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<25>(s12,s13,s14,s23,s24),box6(s24,-s12-s13-s14-s23-s24,-s12-s13-s14,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<26>(s12,s13,s14,s23,s24),box6(s24,s12+s13+s23,s13,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<27>(s12,s13,s14,s23,s24),box6(-s12-s23-s24,s12+s14+s24,s14,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<28>(s12,s13,s14,s23,s24),box6(-s12-s23-s24,s12+s13+s23,s13,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<29>(s12,s13,s14,s23,s24),box6(-s12-s13-s14-s23-s24,s12+s14+s24,s12,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<30>(s12,s13,s14,s23,s24),box6(-s12-s13-s14-s23-s24,s12+s13+s23,s12,3),0);
    fooAFbox += CAm2CF*productCoeff(qq2yygCAm2CF<31>(s12,s13,s14,s23,s24),box6(s12+s14+s24,s12+s13+s23,s12,3),0);
    return fooAFbox;
}
