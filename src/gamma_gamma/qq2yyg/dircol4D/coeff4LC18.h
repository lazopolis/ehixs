...
template<>
double qq2yyg4LC<18,0>(const double& s12, const double& s13, const double& s14, const double& s23, const double& s24)
{
...
template<>
double qq2yyg4LC<18,1>(const double& s12, const double& s13, const double& s14, const double& s23, const double& s24)
{
...
// Coefficient order epsilon^2 of master 18
template<>
double qq2yyg4LC<18,2>(const double& s12, const double& s13, const double& s14, const double& s23, const double& s24)
{
...
template<>
Expansion<Parameter::epsilon, double> qq2yyg4LC<18>(const double& s12, const double& s13, const double& s14, const double& s23, const double& s24)
{
    return Expansion<Parameter::epsilon, double>(0,{
        qq2yyg4LC<18,0>(s12,s13,s14,s23,s24),
        qq2yyg4LC<18,1>(s12,s13,s14,s23,s24),
        qq2yyg4LC<18,2>(s12,s13,s14,s23,s24)
    });
}
