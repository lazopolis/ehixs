...
template<>
template<>
EpsExp qq2yyg1<TT>::Nf::box::c<2>(const TT& zb, const TT& t12, const TT& t34, const TT& u)
{
    return EpsExp(-1,{
        c<2,-1>(zb,t12,t34,u)
    });
