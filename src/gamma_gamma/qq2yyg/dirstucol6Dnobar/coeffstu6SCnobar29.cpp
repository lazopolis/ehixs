...
template<>
double qq2yygstu6SCnobar<29,-1>(const double& z, const double& t12, const double& t34, const double& u)
{
...
template<>
Expansion<Parameter::epsilon, double> qq2yygstu6SCnobar<29>(const double& z, const double& t12, const double& t34, const double& u)
{
    return Expansion<Parameter::epsilon, double>(-1,{
        qq2yygstu6SCnobar<29,-1>(z,t12,t34,u)
    });
}
