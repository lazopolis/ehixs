...
//    std::cout << "Total: " << (1./3.)*qq2yyg1<rtn>::LC::bub::eval(prtn) << "\n";

//    EpsExp foo = pdbl.zb*qq2yyg0(pdbl.zb,pdbl.t12,pdbl.t34,pdbl.u);
//    std::cout << endl;
//    std::cout << "LC poles: " << times(
//                                       qq2yyg1<dbl>::LC::factor()*qq2yyg1_rescue::LC::polecoeffs(pdbl.s15,pdbl.s25),
//                                       foo,
//                                       2
//                                       )<< endl;
//    std::cout << "SC poles: " << times(
//                                       qq2yyg1<dbl>::SC::factor()*qq2yyg1_rescue::SC::polecoeffs(),
//                                       foo,
//                                       2
//                                       )<< endl;
...
//    std::cout << std::endl;
//    std::cout << qq2yyg1<dbl>::LC::box::eval(pdbl) << "\t";
//    std::cout << qq2yyg1<qpl>::LC::box::eval(pqpl) << "\t";
//    std::cout << qq2yyg1<rtn>::LC::box::eval(prtn) << "\t";
//    std::cout << std::endl;
